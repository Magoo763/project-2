...
function Player(pos) {
  ...
  //this is my code.  delete if unnessary.
...
//Start a new function of Boat
//Elimante code if causes problems
function Boat(pos){
this.pos=pos;
...
//act for Boat
Boat.prototype.act = function(step, level) {
...
//Adds a boat act method
//delete if causes problesm for too Losing
...
Player.prototype.moveX = function(step, level, keys) {
  this.speed.x = 0;
  //add an extra variable.  delete if necessary
...
Player.prototype.act = function(step, level, keys) {
  ...
  if (otherActor)
    ...
    //add an extra loop for my own variable
